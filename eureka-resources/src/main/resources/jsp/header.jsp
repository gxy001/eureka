...
<div id="header">
  ...
  <% if (registry.isBelowRenewThresold() == 1) {
   ...
   %>
  <h4 id="uptime"><font size="+1" color="blue"><b>RENEWALS ARE LESSER THAN THE THRESHOLD.THE SELF PRESERVATION MODE IS TURNED OFF.THIS MAY NOT PROTECT INSTANCE EXPIRY IN CASE OF NETWORK/OTHER PROBLEMS.</b></font></h4>
   <%} else {%>
  ...
  <% } else if (!registry.shouldAllowAccess(true)) { %>
    <h4 id="uptime"><font size="+1" color="blue"><b>This server is not allowing registry fetch for remote registry.</b></font></h4>
  <%}%>
</div>
